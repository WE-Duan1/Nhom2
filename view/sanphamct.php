            ...
            <div class ="col-sm-3">
                ...
                <div class="">
                    ...
                    <div class="amount-form" style="margin-left: 20px;">
                        ...
                        <a href=""><input type="submit" value="Add To Cart" class="btn btn-default border-0" style="margin:0 0 15px 15px; width:120px; background: linear-gradient(131deg, rgba(255,117,0,1) 12%, rgba(255,184,0,1) 86%); color:#fff;"></a>
                    </div>
                </div>
                <div class="">
